...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-H7KDHFK6.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-H7KDHFK6.js")).default(client, args);
    case "add":
      return (await import("./add-BHCMFK52.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-CVI3TQHN.js")).default(client, args);
    case "rm":
      return (await import("./rm-U37YHRNF.js")).default(client, args);
    case "update":
      return (await import("./update-O6FSP627.js")).default(client, args);
    default:
